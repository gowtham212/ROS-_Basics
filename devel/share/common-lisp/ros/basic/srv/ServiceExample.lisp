...
(cl:defmethod cl:initialize-instance :after ((m <ServiceExample-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServiceExample-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basic-srv:<ServiceExample-request> is deprecated: use basic-srv:ServiceExample-request instead.")))

(cl:ensure-generic-function 'onezero-val :lambda-list '(m))
(cl:defmethod onezero-val ((m <ServiceExample-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basic-srv:onezero-val is deprecated.  Use basic-srv:onezero instead.")
  (onezero m))
...
(cl:defmethod cl:initialize-instance :after ((m <ServiceExample-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ServiceExample-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name basic-srv:<ServiceExample-response> is deprecated: use basic-srv:ServiceExample-response instead.")))

(cl:ensure-generic-function 'turn-val :lambda-list '(m))
(cl:defmethod turn-val ((m <ServiceExample-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader basic-srv:turn-val is deprecated.  Use basic-srv:turn instead.")
  (turn m))
